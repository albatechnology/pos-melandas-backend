    ...
    @can('colour_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                ...
                @include('csvImport.customModal', ['model' => 'Colour', 'route' => 'admin.colours.parseCsvImport', 'type' => \App\Enums\Import\ImportBatchType::COLOUR])
            </div>
        </div>
    @endcan
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Colour">
                <thead>
                <tr>
                    <th width="10">
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.colours.index') }}",
                columns: [
                    ...
                    {data: 'product_brand_name', name: 'product_brand.name'},
                    {data: 'product_brand.code', name: 'product_brand.code'},
            ...
            let table = $('.datatable-Colour').DataTable(dtOverrideGlobals);
