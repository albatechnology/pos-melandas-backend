    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.discounts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activation_code') ? 'is-invalid' : '' }}" type="text" name="activation_code" id="activation_code" value="{{ old('activation_code', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('scope') ? 'is-invalid' : '' }}" name="scope" id="scope">
                    ...
                    @foreach(App\Models\Discount::SCOPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('scope', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('scope'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_discount_price_per_order') ? 'is-invalid' : '' }}" type="number" name="max_discount_price_per_order" id="max_discount_price_per_order" value="{{ old('max_discount_price_per_order', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_use_per_customer') ? 'is-invalid' : '' }}" type="number" name="max_use_per_customer" id="max_use_per_customer" value="{{ old('max_use_per_customer', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_order_price') ? 'is-invalid' : '' }}" type="number" name="min_order_price" id="min_order_price" value="{{ old('min_order_price', '') }}" step="0.01">
