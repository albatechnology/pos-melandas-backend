                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Activity::FOLLOW_UP_METHOD_SELECT as $key => $item)
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Activity::STATUS_SELECT as $key => $item)
                                <option value="{{ $key }}">{{ $item }}</option>
                            @endforeach
                        </select>
                    </td>
...
{ data: 'lead_label', name: 'lead.label' },
{ data: 'products', name: 'products.name' },
{ data: 'follow_up_datetime', name: 'follow_up_datetime' },
