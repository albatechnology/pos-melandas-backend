    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.update", [$customer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('default_address_id') ? 'is-invalid' : '' }}" type="number" name="default_address_id" id="default_address_id" value="{{ old('default_address_id', $customer->default_address_id) }}" step="1">
