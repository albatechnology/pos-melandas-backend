    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-customerLeads">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($leads as $key => $lead)
                            <tr data-entry-id="{{ $lead->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $lead->is_new_customer ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-customerLeads:not(.ajaxTable)').DataTable({ buttons: dtButtons })
