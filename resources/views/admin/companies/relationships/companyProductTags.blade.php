    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-companyProductTags">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.productTag.fields.company') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-companyProductTags:not(.ajaxTable)').DataTable({ buttons: dtButtons })
