...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Promo">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'promotable_type', name: 'promotable_type' },
{ data: 'promotable_identifier', name: 'promotable_identifier' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Promo').DataTable(dtOverrideGlobals);
