...
@can('catalogue_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'Catalogue', 'route' => 'admin.catalogues.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Catalogue">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'id', name: 'id' },
{ data: 'catalogue', name: 'catalogue', sortable: false, searchable: false },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Catalogue').DataTable(dtOverrideGlobals);
